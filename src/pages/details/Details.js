...
const Details = () => {
  ...
  return (
    <div className={`text-${mode === "dark" ? "light" : "dark"} borde-${mode === "dark" ? "light" : "dark"} `}>
          ...
          tarif && (
            <>
              ...
              <div className="col-12 mt-3">
                ...
                <a href={tarif.url} className={`btn btn-outline-${color} float-end`} target="_blank" rel="noreferrer" >Tarif Sitesi</a>
              </div>
            </>
          )
        }
